...
module HotelPortal
  module FrontDesk
    class ArrivalsQuery
      ...
      def call
        scope = base_scope.includes(:booking_rooms, :pre_checkin, :booking_notes, :ar_payment_submissions, booking_guests: { guest: :bookings }, booking_folios: [ :folio_transactions, :folio_forecasted_charges ])
