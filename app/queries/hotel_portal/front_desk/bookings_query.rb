...
module HotelPortal
  module FrontDesk
    class BookingsQuery
      ...
      def call
        scope = @hotel.bookings.recent_first.order(id: :desc).includes(:ar_payment_submissions, booking_rooms: :room_type, booking_folios: [ :folio_transactions, :folio_forecasted_charges ], booking_guests: { guest: :bookings })
