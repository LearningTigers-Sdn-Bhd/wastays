...
export default class extends Controller {
  ...
  connect() {
    ...
    window.addEventListener("booking-timeline-board:open-extend-duration", this.boundOpenExtendDuration)
    window.addEventListener("booking-timeline-board:close-all", this.boundCloseAll)
  }

  disconnect() {
    window.removeEventListener("booking-timeline-board:open-extend-duration", this.boundOpenExtendDuration)
    window.removeEventListener("booking-timeline-board:close-all", this.boundCloseAll)
  }

  openExtendDuration() {
    this.openOverlay("booking-timeline-board-extend-duration-overlay", null, null)
  }
