  ...
  module Orchestration
    module Sales
      ...
      class NextActionPolicy
        ...
        def initialize(intent:, outcome:, booking_task:, resumable_booking:, needs_human_support: false, suppress_offer: false)
          @intent = intent.to_s
        ...
        attr_reader :intent, :outcome, :booking_task, :resumable_booking, :needs_human_support, :suppress_offer
