  ...
  class EnsureDefaultGlMaps
    ...
    def call
      mappings = {
        ...
        "no_show_charge" => { code: "4030", desc: "No-Show Charge Revenue" },
        "cancellation_charge" => { code: "4033", desc: "Cancellation Charge Revenue" },
        "late_checkout_charge" => { code: "4031", desc: "Late Checkout Charge Revenue" },
        "early_departure_charge" => { code: "4032", desc: "Early Departure Charge Revenue" },
        "parking" => { code: "4090", desc: "Parking Revenue" },
