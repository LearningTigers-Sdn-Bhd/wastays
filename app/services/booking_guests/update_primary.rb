    ...
    def primary_booking_params
      {
        ...
        guest_city: @attributes[:city],
        guest_state_code: @attributes[:state_code],
        guest_postal_code: @attributes[:postal_code],
        guest_address_country: @attributes[:address_country],
