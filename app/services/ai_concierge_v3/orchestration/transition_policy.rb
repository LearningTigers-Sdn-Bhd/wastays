  ...
  module Orchestration
    ...
    def call
      ...
      if pending_question == "party_split"
        return action(:search_options) unless missing_party_split?
        return action(:ask_party_split) if interpretation["intent"] == "confirmation"
      end
      ...
      return action(:ask_specific_timing) if missing_specific_timing?
