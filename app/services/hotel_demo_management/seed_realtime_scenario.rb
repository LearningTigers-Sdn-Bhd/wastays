  ...
  class SeedRealtimeScenario
    ...
    def guest_profiles
      @guest_profiles ||= [
        ...
        { country: "Japan", name: "Kenji Sato", email: "kenji.sato@example.co.jp", phone: "+819012345678", document_type: "passport", government_id: "TK9876543", date_of_birth: Date.new(1988, 5, 14) },
        { country: "Japan", name: "Yuka Tanaka", email: "yuka.tanaka@example.co.jp", phone: "+819087654321", document_type: "passport", government_id: "TK1234567", date_of_birth: Date.new(1992, 1, 22) },
        { country: "Japan", name: "Hiroshi Watanabe", email: "hiroshi.watanabe@example.co.jp", phone: "+818023456789", document_type: "passport", government_id: "TK2345678", date_of_birth: Date.new(1985, 9, 3) },
        { country: "Japan", name: "Mai Takahashi", email: "mai.takahashi@example.co.jp", phone: "+818034567890", document_type: "passport", government_id: "TK3456789", date_of_birth: Date.new(1994, 7, 11) },
        { country: "Japan", name: "Takashi Kobayashi", email: "takashi.kobayashi@example.co.jp", phone: "+819045678901", document_type: "passport", government_id: "TK4567890", date_of_birth: Date.new(1989, 12, 28) },
        { country: "South Korea", name: "Min-jun Kim", email: "minjun.kim@example.co.kr", phone: "+821012345678", document_type: "passport", government_id: "M12345678", date_of_birth: Date.new(1991, 4, 6) },
        { country: "South Korea", name: "Seo-yeon Lee", email: "seoyeon.lee@example.co.kr", phone: "+821087654321", document_type: "passport", government_id: "M23456789", date_of_birth: Date.new(1993, 8, 19) },
        { country: "South Korea", name: "Ji-hoon Park", email: "jihoon.park@example.co.kr", phone: "+821023456789", document_type: "passport", government_id: "M34567890", date_of_birth: Date.new(1987, 3, 25) },
        { country: "South Korea", name: "Ji-woo Choi", email: "jiwoo.choi@example.co.kr", phone: "+821034567890", document_type: "passport", government_id: "M45678901", date_of_birth: Date.new(1996, 10, 2) },
        { country: "South Korea", name: "Hyun-woo Jung", email: "hyunwoo.jung@example.co.kr", phone: "+821045678901", document_type: "passport", government_id: "M56789012", date_of_birth: Date.new(1990, 6, 15) },
        { country: "Hong Kong", name: "Chun-hei Chan", email: "chunhei.chan@example.com.hk", phone: "+85291234567", document_type: "passport", government_id: "H98765432", date_of_birth: Date.new(1986, 11, 8) },
        { country: "Hong Kong", name: "Hoi-ching Wong", email: "hoiching.wong@example.com.hk", phone: "+85298765432", document_type: "passport", government_id: "H12345678", date_of_birth: Date.new(1995, 2, 17) },
        { country: "Hong Kong", name: "Yat-long Lee", email: "yatlong.lee@example.com.hk", phone: "+85292345678", document_type: "passport", government_id: "H23456789", date_of_birth: Date.new(1984, 1, 30) },
        { country: "Hong Kong", name: "Wing-shan Cheung", email: "wingshan.cheung@example.com.hk", phone: "+85293456789", document_type: "passport", government_id: "H34567890", date_of_birth: Date.new(1997, 9, 9) },
        { country: "Hong Kong", name: "Tsz-hin Ng", email: "tszhin.ng@example.com.hk", phone: "+85294567890", document_type: "passport", government_id: "H45678901", date_of_birth: Date.new(1991, 12, 4) },
        { country: "Indonesia", name: "Budi Santoso", email: "budi.santoso@example.co.id", phone: "+628123456789", document_type: "passport", government_id: "B9876543", date_of_birth: Date.new(1988, 4, 12) },
        { country: "Indonesia", name: "Dewi Lestari", email: "dewi.lestari@example.co.id", phone: "+6281398765432", document_type: "passport", government_id: "B1234567", date_of_birth: Date.new(1993, 7, 21) },
        { country: "Indonesia", name: "Aditya Wijaya", email: "aditya.wijaya@example.co.id", phone: "+6281723456789", document_type: "passport", government_id: "B2345678", date_of_birth: Date.new(1987, 5, 5) },
        { country: "Indonesia", name: "Putri Indah", email: "putri.indah@example.co.id", phone: "+6281634567890", document_type: "passport", government_id: "B3456789", date_of_birth: Date.new(1998, 3, 14) },
        { country: "Indonesia", name: "Joko Widodo", email: "joko.widodo@example.co.id", phone: "+6281945678901", document_type: "passport", government_id: "B4567890", date_of_birth: Date.new(1985, 8, 27) }
      ]
    end
  end
end
