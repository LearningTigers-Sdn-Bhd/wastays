...
module HotelOps
  class SeedAccountRoles
    ROLE_TEMPLATES = [
      ...
      { name: "Front Desk", slug: "front_desk", permissions: %w[view_bookings manage_bookings view_guest_records manage_guest_arrival manage_room_status post_charges post_folio_charges post_folio_payments manage_requests manage_night_audit manage_concierge manage_housekeeping_tasks] },
