...
module Folios
  module Lifecycle
    class InitializeForBooking
      ...
      def initialize_folio
        BookingFolio.transaction do
          ...
          unless folio.present?
            ...
            Folios::Payments::SyncExistingPayments.call(folio: folio, user: @user, options: @options)
      ...
      def create_folio!
        Folios::Lifecycle::BuildPrimaryFolio.call(booking: @booking, actor: @user, hotel: @booking.hotel)
      end
