  ...
  module Routing
    class ApplyGroupBatch
      ...
      def call
        ...
        ActiveRecord::Base.transaction do
          ...
          if batch&.completed_at?
            return Folios::Routing::GroupBatchResult.success(transactions: [], touched_booking_ids: [])
          end
          ...
          BookingAuditLog.create!(hotel: @group_booking.hotel, auditable: @group_booking, user: @actor,
            action_type: "group_billing_routes_changed", category: "financial", source: "booking_workspace",
        ...
        Folios::Routing::GroupBatchResult.success(transactions: moved, touched_booking_ids: touched_ids)
      ...
      def preview
        ...
        Folios::Routing::GroupBatchPreview.success(bookings: results,
      ...
      def failure(message)
        Folios::Routing::GroupBatchResult.failure(message, transactions: [], touched_booking_ids: [])
      end

      def preview_failure(message)
        Folios::Routing::GroupBatchPreview.failure(message)
      end
    end
  end
end
