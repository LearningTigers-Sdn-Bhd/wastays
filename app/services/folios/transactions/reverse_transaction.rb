  ...
  module Transactions
    class ReverseTransaction
      ...
      def call
        ...
        policy = Folios::Transactions::TransactionActionPolicy.new(transaction: @transaction, user: @user, posting_date: @posting_date)
        ...
        ActiveRecord::Base.transaction do
          ...
          originals.each do |original|
            original_policy = Folios::Transactions::TransactionActionPolicy.new(transaction: original, user: @user, posting_date: @posting_date)
      ...
      def policy_for_transaction
        @policy_for_transaction ||= Folios::Transactions::TransactionActionPolicy.new(transaction: @transaction, user: @user, posting_date: @posting_date)
      end
      ...
      def reconcile_forecast_after_reversal!(original)
        ...
        forecast.supersede!
        Folios::Forecasts::SyncForecastedCharges.call(booking_folio: original.booking_folio)
      end
      ...
      def success(transaction, transactions = [ transaction ])
        Folios::Transactions::TransactionResult.success(transaction: transaction, transactions: transactions)
      end
