  ...
  module Transactions
    class PostStaffTransaction
      ...
      def resolve_manual_charge_folio
        return Folios::Routing::RouteResult.success(folio: @folio, route_metadata: {}) unless manual_charge_with_code?

        resolved = Folios::Routing::ResolveTargetFolio.call(booking: @folio.booking, transaction_code: @transaction_code, actor: @user, permission_context: @options[:permission_context] || @user)
      ...
      def selected_folio_route
        Folios::Routing::RouteResult.success(
          folio: @folio,
      ...
      def apply_payment_source
        ...
        @payment_source = Folios::Payments::PaymentSource.fetch(source_key)
      ...
      def validate_refund_source
        ...
        return "Refund source is not valid." unless Folios::Payments::RefundSource.valid?(source_key)
