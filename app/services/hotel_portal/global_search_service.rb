...
class HotelPortal::GlobalSearchService < BaseGlobalSearchService
  ...
  PAGE_RESULTS = [
    ...
    { title: "Policies", subtitle: "Policies shared with guests", route: :hotel_knowledge_policies_path, keywords: "policy policies property rules regulations", layer: :settings, permission: "manage_hotel_profile" },
