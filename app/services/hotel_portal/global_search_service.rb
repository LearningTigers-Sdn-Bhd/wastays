...
class HotelPortal::GlobalSearchService < BaseGlobalSearchService
  ...
  PAGE_RESULTS = [
    ...
    { title: "Room Inventory", subtitle: "Manage room types and rate plans", route: :hotel_room_types_path, keywords: "room inventory room categories room types rate plans", layer: :settings, permission: "manage_hotel_profile" },
    ...
    { title: "Hotel Album", subtitle: "Property photos and featured image", route: :hotel_album_path, keywords: "hotel album photos pictures images gallery featured photo", layer: :settings, permission: "manage_hotel_profile" },
    ...
    { title: "Guest Content", subtitle: "Information shared with guests", route: :hotel_guest_content_path, keywords: "guest content information", layer: :settings, permission: "manage_hotel_profile" },
    { title: "AI Concierge", subtitle: "AI concierge configuration", route: :hotel_ai_concierge_settings_path, keywords: "ai concierge guest content", plan_feature: "ai_concierge_page", layer: :settings, permission: "manage_hotel_profile" },
    { title: "Policies", subtitle: "Policies shared with guests", route: :hotel_policy_reservations_path, keywords: "policy policies property rules regulations house", layer: :settings, permission: "manage_hotel_profile" },
    { title: "FAQs", subtitle: "Frequently asked guest questions", route: :hotel_knowledge_faqs_path, keywords: "faq faqs frequently asked questions answers", layer: :settings, permission: "manage_hotel_profile" },
    { title: "Hotel Info", subtitle: "General information shared with guests", route: :hotel_knowledge_general_infos_path, keywords: "general info information property hotel", layer: :settings, permission: "manage_hotel_profile" },
    { title: "Amenities", subtitle: "Guest-facing amenity details", route: :hotel_guest_amenities_path, keywords: "amenity amenities hours location fee", layer: :settings, permission: "manage_hotel_profile" },
    { title: "Wi-Fi", subtitle: "Guest Wi-Fi networks", route: :hotel_wifi_networks_path, keywords: "wifi wi-fi network ssid", layer: :settings, permission: "manage_hotel_profile" },
    { title: "AI Healthcheck", subtitle: "Review AI concierge knowledge gaps", route: :hotel_ai_healthchecks_path, keywords: "ai healthcheck knowledge diagnostics concierge gaps", plan_feature: "ai_concierge_page", layer: :settings, permission: "manage_hotel_profile" },
    ...
    { title: "Booking Performance", subtitle: "Booking sales and payout breakdown", route: :breakdown_hotel_reports_path, keywords: "booking performance sales financial breakdown reports", layer: :reports, permission: "view_reports" },
