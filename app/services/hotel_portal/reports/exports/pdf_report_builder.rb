  ...
  module Reports
    module Exports
      class PdfReportBuilder
        def initialize(hotel:, title:, period_label:, prepared_by:, period_label_title: "Period", subtitle: nil, eyebrow: nil, metadata: nil, generated_at: Time.current, page_layout: :portrait, confidential: true, hotel_contact: nil)
