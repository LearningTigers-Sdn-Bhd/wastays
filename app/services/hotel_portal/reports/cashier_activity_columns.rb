...
module HotelPortal
  module Reports
    CashierActivityColumns = ReportColumns.build(
      columns: [
        ReportColumns.column(key: "date_time", label: "Date and time", export_labels: [ "Date & Time" ], pdf_label: "Date & Time", pdf_width: 72, excel_width: 22, type: :date),
        ReportColumns.column(key: "date", label: "Date", export_labels: [ "Date" ], pdf_label: "Date", pdf_width: 62, excel_width: 14, type: :date),
        ReportColumns.column(key: "time", label: "Time", export_labels: [ "Time" ], pdf_label: "Time", pdf_width: 44, excel_width: 10, type: :text),
        ReportColumns.column(key: "reservation", label: "Booking", export_labels: [ "Booking No.", "Confirmation Code" ], pdf_label: "Booking", pdf_width: 82, excel_width: 20, type: :text),
        ReportColumns.column(key: "booking_number", label: "Booking number", export_labels: [ "Booking No." ], pdf_label: "Booking No.", pdf_width: 70, excel_width: 18, type: :text),
        ReportColumns.column(key: "confirmation_code", label: "Confirmation number", export_labels: [ "Confirmation Code" ], pdf_label: "Confirmation", pdf_width: 78, excel_width: 20, type: :text),
        ReportColumns.column(key: "guest_details", label: "Guest and room", export_labels: [ "Guest", "Room" ], pdf_label: "Guest / Room", pdf_width: 100, excel_width: 28, type: :text),
        ReportColumns.column(key: "folio", label: "Folio", export_labels: [ "Folio" ], pdf_label: "Folio", pdf_width: 70, excel_width: 18, type: :text),
