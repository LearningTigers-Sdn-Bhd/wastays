    ...
    class RequestsController < BaseController
      ...
      def create
        ...
        if params[:stage] != "submit"
          ...
          return redirect_to concierge_new_request_path(@hotel.unique_id, @hotel.public_id, stage: "submit")
        end
        ...
        if result.success?
          ...
          redirect_to concierge_request_success_path(@hotel.unique_id, @hotel.public_id)
        else
