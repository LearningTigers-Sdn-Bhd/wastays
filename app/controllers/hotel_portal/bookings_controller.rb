...
class HotelPortal::BookingsController < HotelPortal::BaseController
  ...
  def booking_params
    params.fetch(:booking, {}).permit(
      ...
      :guest_country, :guest_city, :guest_state_code, :guest_postal_code, :guest_tin, :guest_gender, :guest_document_type, :guest_government_id, :guest_date_of_birth, :guest_update_intent,
