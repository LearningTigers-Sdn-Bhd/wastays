...
module HotelPortal
  class TaxesFeesPresenter
    RegistryRow = Data.define(
      ...
      :code,
      :applies_to,
      # One column, not two: "8.00%" already says percentage and "RM 3.00" already
      # says fixed, so a separate rule column restated what the figure showed.
      :rate,
      :tax_number,
      :enabled,
      :manage_path,
    ...
    def sst_row
      RegistryRow.new(
        ...
        rate: "8.00%",
        tax_number: hotel.sst_registration_number,
    ...
    def tourism_tax_row
      RegistryRow.new(
        ...
        rate: "RM #{formatted_amount(hotel.tourism_tax_amount)} / room / night",
        tax_number: hotel.tourism_tax_registration_number,
    ...
    def custom_row(tax)
      RegistryRow.new(
        ...
        rate: tax.rate_type == "percentage" ? "#{formatted_amount(tax.amount)}%" : "RM #{formatted_amount(tax.amount)}",
        tax_number: tax.registration_number,
        enabled: tax.enabled?,
