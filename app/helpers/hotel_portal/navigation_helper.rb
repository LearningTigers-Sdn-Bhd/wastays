      ...
      @_hotel_sidebar_sections = [
        ...
        NavSection.new(
          ...
          items: [
            ...
            NavItem.new(label: "Room Status Board", path: hotel_room_status_board_path(current_hotel), search_text: "Room Status Tape Chart Housekeeping Assignment Operations", active: controller_name == "room_status_board", icon: "layout-grid", permission: [ "view_room_readiness", "manage_room_status" ], plan_feature: "room_status_board"),
            NavItem.new(label: "Housekeeping Tasks", path: hotel_housekeeping_tasks_path(current_hotel), search_text: "Housekeeping Tasks Cleaning Room Status Operations", active: controller_name == "housekeeping_tasks", icon: "clipboard-check", permission: "manage_housekeeping_tasks", plan_feature: "task_assignment_minibar_log"),
