  ...
  module NavigationHelper
    ...
    def hotel_sidebar_sections
      ...
      accounts_receivable_nav_items = [
        ...
        NavItem.new(label: "Payment Submissions", path: hotel_ar_payment_submissions_path(current_hotel), search_text: "Payment Submissions Agent Slip Verification Accounts Receivable Finance", active: controller_name == "ar_payment_submissions", icon: "upload", permission: "manage_ar_payments"),
