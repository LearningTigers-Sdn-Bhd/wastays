      ...
      @_hotel_sidebar_sections = [
        ...
        NavSection.new(
          ...
          items: [
            ...
            NavItem.new(label: "Housekeeping Tasks", path: hotel_housekeeping_tasks_path(current_hotel), search_text: "Housekeeping Tasks Cleaning Room Status Operations", active: controller_name == "housekeeping_tasks", icon: "clipboard-check", permission: "manage_requests", plan_feature: "task_assignment_minibar_log"),
