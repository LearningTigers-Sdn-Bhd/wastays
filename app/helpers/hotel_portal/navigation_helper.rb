      ...
      @_hotel_sidebar_sections = [
        ...
        NavSection.new(
          ...
          items: [
            ...
            NavItem.new(label: "Housekeeping Tasks", path: hotel_housekeeping_tasks_path(current_hotel), search_text: "Housekeeping Tasks Request Clean Operations Room Table", active: controller_name == "housekeeping_tasks", icon: "clipboard-check", permission: "manage_requests", plan_feature: "task_assignment_minibar_log"),
