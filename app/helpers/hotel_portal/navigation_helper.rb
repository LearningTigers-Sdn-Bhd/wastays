      ...
      @_hotel_sidebar_sections = [
        ...
        NavSection.new(
          ...
          items: [
            ...
            NavItem.new(label: "Guest Records", path: hotel_guests_path(current_hotel), search_text: "Guest Records Guests Directory", active: controller_name == "guests", icon: "user", permission: "view_guest_records")
          ]
        ),
        NavSection.new(
          label: "Property",
