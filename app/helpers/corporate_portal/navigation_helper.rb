      ...
      finance_items = [
        ...
        PanelsUI::Navigation::Item.new(
          ...
          children: [
            ...
            PanelsUI::Navigation::Item.new(label: "Submit Payment", path: new_corporate_ar_payment_submission_path, search_text: "Submit Payment Slip Bank Transfer Accounts Receivable", active: controller_name == "ar_payment_submissions", icon: "upload")
          ]
        ),
        PanelsUI::Navigation::Item.new(
          label: "Statements",
