...
8. `app/services/ai_concierge_v3/state/slot_merger.rb` — slot merging
9. `app/services/ai_concierge_v3/state/conversation_task_manager.rb` — task state
10. `app/services/ai_concierge_v3/matching/room_type_matcher.rb` — room resolution
11. `app/services/ai_concierge_v3/message_builders/` — reply rendering
12. `app/services/ai_concierge_v3/tools/` — tool implementations
