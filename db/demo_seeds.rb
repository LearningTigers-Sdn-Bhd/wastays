...
module DemoSeeds
  ...
  ROLE_TEMPLATES = [
    ...
    { name: "Front Desk", slug: "front_desk", permissions: %w[view_bookings manage_bookings view_guest_records manage_guest_arrival manage_night_audit post_folio_charges post_folio_payments override_financial_date_lock] },
