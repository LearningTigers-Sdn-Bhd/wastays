...
Rails.application.configure do
  demo_host = ENV.fetch("DEMO_HOST", "demo.wastays.com")
  demo_protocol = ENV.fetch("DEMO_PROTOCOL", "https")
  ...
  # Only use :id for inspections in demo to match production.
  config.active_record.attributes_for_inspect = [ :id ]

  # Enable DNS rebinding protection and other `Host` header attacks.
  config.hosts << demo_host
