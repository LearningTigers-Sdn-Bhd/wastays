...
Rails.application.configure do
  ...
  config.action_mailer.default_url_options = { host: "localhost", port: ENV.fetch("PORT", 3000).to_i, protocol: "http" }
  ...
  # Temporarily hardcode encryption keys to unblock db:reset
