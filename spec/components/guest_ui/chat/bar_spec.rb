...
RSpec.describe GuestUI::Chat::Bar, type: :component do
  it "names the hotel the guest is talking to, and who is answering" do
    ...
    expect(page).to have_css(".guest-chat__bar-title", text: "Aurora Crown Resort")
    expect(page).to have_css(".guest-chat__status", text: "Our front desk replies here")
  end
  ...
  it "offers a way back out when it is given one" do
    ...
    expect(page).to have_css("a.guest-chat__bar-back[href='/concierge/aurora'][aria-label='Back']")
  end
  ...
  it "leaves the way out off a page that has nowhere to go back to" do
    ...
    expect(page).to have_no_css(".guest-chat__bar-back")
  end
  ...
  it "holds actions on the whole conversation" do
    ...
    expect(page).to have_css(".guest-chat__bar-actions", text: "MENU")
  end

  it "leaves the actions box out rather than rendering an empty one" do
    render_inline(described_class.new(title: "Aurora Crown Resort"))

    expect(page).to have_no_css(".guest-chat__bar-actions")
  end
end
