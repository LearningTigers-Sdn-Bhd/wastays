...
RSpec.describe BookingBillingTerms, type: :model do
  ...
  it "rejects City Ledger for guests and ineligible company accounts" do
    ...
    expect(described_class.new(booking_billing_party: guest_party, settlement_type: "city_ledger")).not_to be_valid
    expect(described_class.new(booking_billing_party: company_party, settlement_type: "city_ledger")).not_to be_valid
  end
end
