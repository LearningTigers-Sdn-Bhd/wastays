...
RSpec.describe HotelPortal::FrontDesk::CheckoutQuery do
  ...
  describe "#call" do
...

    {
      ...
      it "searches literal percent and underscore in #{description}" do
        ...
        query = described_class.new(hotel:, params: { checkout_query: "A%_B" })
  ...
  it "prefers scoped dates over legacy dates" do
    ...
    query = described_class.new(hotel:, params: { start_date: "2026-07-15", checkout_start_date: "2026-07-16" })
  ...
  it "uses the hotel-local day for invalid and missing dates", :hotel_midnight do
    ...
    invalid = described_class.new(hotel:, params: { checkout_start_date: "not-a-date" })
  ...
  describe "#total_count" do
    it "keeps count unfiltered" do
      ...
      query = described_class.new(hotel:, params: { checkout_query: "Aisha" })
