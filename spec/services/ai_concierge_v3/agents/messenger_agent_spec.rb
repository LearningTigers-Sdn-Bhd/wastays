...
RSpec.describe AiConciergeV3::Agents::MessengerAgent do
  ...
  it "strips hallucinated month_segment for vague month requests" do
    ...
    result = AiConciergeV3::Orchestration::TurnOrchestrator.new(hotel: hotel, message: "can i book on june", prospect_public_id: prospect.public_id).call
  ...
  it "extracts pure month segment when pending_question is specific_timing" do
    ...
    result = AiConciergeV3::Orchestration::TurnOrchestrator.new(hotel: hotel, message: "mid", prospect_public_id: prospect.public_id).call
