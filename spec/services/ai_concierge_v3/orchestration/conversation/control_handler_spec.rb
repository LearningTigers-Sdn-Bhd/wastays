...
RSpec.describe AiConciergeV3::Orchestration::Conversation::ControlHandler do
  ...
  let(:response_persister) { AiConciergeV3::Orchestration::Conversation::ResponsePersister.new(hotel: hotel) }
