...
RSpec.describe HotelOps::SeedAccountRoles do
  ...
  it "creates role templates and links existing permissions" do
    ...
    expect(front_desk.permissions.pluck(:slug)).not_to include("execute_folio_refunds", "post_folio_write_offs", "post_folio_corrections")
  end
end
