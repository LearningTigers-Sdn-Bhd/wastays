...
RSpec.describe HotelPortal::Reports::DailyRevenueCsvExportService do
  it "generates csv" do
    ...
    expect(csv).to include("Date,Bookings,Accommodation,Other Charges,Tax,Total Charges,Discount,Online,Cash,Deposit,Agent Transfer,Refund,Net")
    expect(csv).to include("2026-05-06,2,400.00,5.00,10.00,415.00,15.00,200.00,100.00,50.00,30.00,25.00,325.00")
  end
end
