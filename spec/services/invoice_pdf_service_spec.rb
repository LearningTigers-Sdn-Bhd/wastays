...
RSpec.describe InvoicePdfService do
  ...
  let(:booking) do
    create(:booking,
      ...
      confirmation_token: "WS-TESTINV1",
      total_amount: 300.0,
      currency: "MYR",
  ...
  context "with tourism tax" do
    before do
      booking.update!(tourism_tax_applied: true, tourism_tax_amount: 10.0)
    end
  ...
  context "with empty room_type_snapshot" do
    before do
      booking_room.update!(room_type_snapshot: {})
    end
