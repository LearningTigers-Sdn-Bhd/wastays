...
RSpec.describe Folios::Charges::PostNightlyCharges do
  ...
  it "does not duplicate nightly charges posted on another folio for the same booking" do
    ...
    key = Folios::Charges::ChargePostingKeys.nightly_charge_key(booking: booking, date: business_date, charge_kind: "accommodation", identity: booking_room.id)
