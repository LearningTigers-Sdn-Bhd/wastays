...
RSpec.describe Folios::Routing::RefreshBookingForecasts do
  ...
  it "updates snapshots without syncing when no folio exists" do
    ...
    snapshot = double(tax_lines: [], tax_posting_snapshot: {})
    ...
    expect(Folios::Forecasts::SyncForecastedCharges).not_to have_received(:call)
  end
end
