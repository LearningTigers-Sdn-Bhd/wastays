...
RSpec.describe "HotelPortal::ArStatements", type: :request do
  ...
  it "always shows the flat ledger on-screen regardless of report_type, and offers per-invoice charge breakdowns only via the Detail PDF download" do
    ...
    get pdf_hotel_ar_statement_path(
      hotel,
      relationship,
      "account-statement-atlas-travel-2026-06-01-2026-06-30-MYR.pdf"
  ...
  it "generates the full PDF without the export feature gate" do
    ...
    filename = "account-statement-atlas-travel-2026-06-01-2026-06-30-MYR.pdf"
    get pdf_hotel_ar_statement_path(hotel, relationship, filename), params: {
      start_date: "2026-06-01",
      end_date: "2026-06-30",
      currency: "MYR"
    }
    ...
    expect(URI.parse(pdf_hotel_ar_statement_path(hotel, relationship, filename)).path).to end_with("/#{filename}")
    expect(text).to include("Account Statement", "PDF-0", "PDF-54", "Generated by WAStays.com")
  end
