...
RSpec.describe "HotelPortal::Bookings::Actions checkouts", frozen_time: :business_day, type: :request do
  ...
  let(:room_type) { create(:room_type, hotel: hotel, name: "Garden Suite", room_number_mode: "custom", quantity: 2, room_numbers: %w[101 102]) }
  let(:booking) do
  ...
  describe "GET the checkout form" do
    it "renders the checkout Sheet with the settlement form in the primary frame" do
      ...
      dialog = document.at_css("turbo-frame#booking_action_sheet dialog#booking-checkout-sheet[data-controller='ui--sheet']")
