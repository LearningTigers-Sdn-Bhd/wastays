...
RSpec.describe "HotelPortal::Bookings::Actions check-ins", frozen_time: :business_day, type: :request do
  let(:hotel) { create(:hotel, status: "live", tourism_tax_enabled: true, tourism_tax_amount: 10.0) }
  ...
  describe "GET the check-in form" do
    it "renders the standard check-in Sheet in the requesting frame" do
      ...
      dialog = document.at_css("turbo-frame#booking_action_sheet dialog#booking-check-in-sheet[data-controller='ui--sheet']")
