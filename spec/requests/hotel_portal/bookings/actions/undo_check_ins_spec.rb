...
RSpec.describe "HotelPortal::Bookings::Actions undo check-ins", frozen_time: :business_day, type: :request do
  ...
  describe "GET the undo-check-in form" do
    it "renders the undo Sheet in the primary frame" do
      ...
      dialog = document.at_css("turbo-frame#booking_action_sheet dialog#booking-undo-check-in-sheet[data-controller='ui--sheet']")
