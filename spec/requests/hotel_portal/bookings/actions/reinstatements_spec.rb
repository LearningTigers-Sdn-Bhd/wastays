...
RSpec.describe "HotelPortal::Bookings::Actions reinstatements", frozen_time: :business_day, type: :request do
  ...
  describe "GET the reinstate form" do
    it "renders the reinstate Sheet with per-room selectors in the primary frame" do
      ...
      dialog = document.at_css("turbo-frame#booking_action_sheet dialog#booking-reinstate-sheet[data-controller='ui--sheet']")
