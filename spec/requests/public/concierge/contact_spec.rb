...
RSpec.describe "Public::Concierge::Contact", type: :request do
  ...
  let(:hotel) { create(:hotel, status: "approved", concierge_enabled: true, plan: plan, address: "123 Main St", city: "Kuala Lumpur", country: "Malaysia", whatsapp_number: "60123456789") }
