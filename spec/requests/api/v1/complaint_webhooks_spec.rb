...
RSpec.describe "Api::V1::ComplaintWebhooks", type: :request do
  ...
  describe "POST /create" do
    it "creates a complaint request without a status" do
      # Set explicit zone for predictable parsing in test
      Time.use_zone("Kuala Lumpur") do
        ...
        # Compare date component in the same time zone
        expect(complaint.requested_at.in_time_zone("Kuala Lumpur").to_date.iso8601).to eq("2026-04-14")
      end
    end
  end
end
