...
RSpec.describe "Api::V1::Hotels", type: :request do
  ...
  let!(:hotel_1) { Hotel.create!(sell_mode: "per_room", account: account, name: "Hotel Alpha", city: "KL", country: "Malaysia", status: "approved") }
  let!(:hotel_2) { Hotel.create!(sell_mode: "per_room", account: account, name: "Hotel Beta", city: "Penang", country: "Malaysia", status: "approved") }
